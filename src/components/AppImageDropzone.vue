...
<template>
  <div class="bg-gray-100 p-2 flex justify-center items-center border-2 border-gray-100 relative" :class="{
    'border-blue-200': isOverDropZone,
    'border-2': isOverDropZone,
  }" ref="dropZoneRef">
    <label class="absolute top-0 left-0 right-0 bottom-0 block">
      <input accept="image/png, image/jpeg" class="hidden" type="file" @change="onFileSelect" />
    </label>
